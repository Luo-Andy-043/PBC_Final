...
class Game:
    ...
    def run(self):
        ...
        while self.playing:
            ...
            # self.screen.blit(self.CLERK.image, self.camera.apply(self.CLERK))
            self.screen.blit(self.CLERK.image, (self.camera.apply(self.CLERK)[0]+1000, self.camera.apply(self.CLERK)[1]+1000))
    ...
    def show_start_game(self):  # 遊戲開始畫面
